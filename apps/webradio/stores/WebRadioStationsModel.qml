...
ListModel{
    ...
    ListElement {
        ...
        url:"http://bbcmedia.ic.llnwd.net/stream/bbcmedia_intl_lc_radio2_p"
    ...
    Radio 3 won the Sony Radio Academy UK Station of the Year Gold Award for 2009[5] and was nominated again in 2011"
        url: "http://bbcmedia.ic.llnwd.net/stream/bbcmedia_intl_lc_radio3_p"
        website: "http://www.bbc.co.uk/radio3"
    }

    ListElement {
        name: "BBCUK Radio 5 live"
        image: "BBCUK Radio 5 live"
        country: ""
    ...
    The station broadcasts from MediaCityUK in Salford[3] and is a department of the BBC North division."
        url: "http://bbcmedia.ic.llnwd.net/stream/bbcmedia_intl_lc_5live_q"
    ...
    ListElement {
        ...
        url: "http://ice-sov.musicradio.com:80/HeartLondonMP3"
    ...
    The stations serve an audience of 7.1 million listeners and target a core audience in the 14-34 age group"
        url: "http://media-ice.musicradio.com:80/Capital"
    ...
    ListElement {
        ...
        url: "http://icy-e-02.sharp-stream.com:80/kiss100.mp3"
    ...
    KCRW broadcasts in the HD radio format."
        url: "http://kcrw.ic.llnwd.net/stream/kcrw_live"
    ...
    ListElement {
        ...
        country: ""
        info: ""
        url: "http://icy-e-05.sharp-stream.com/kerrang.mp3"
        website: "http://www.kerrang.com/"
    }

    ListElement {
        name: "Brooklyn Radio"
        image: "Brooklyn Radio"
        country: ""
        info: ""
        url: "http://streaming.radionomy.com/BrooklynRadio"
        website: "http://brooklynradio.com/"
    }
}
